#
# spec file for package SFEperl-gnome2-rsvg
#
# includes module(s): perl-gnome2-rsvg
#

%include Solaris.inc
Name:                    SFEperl-gnome2-rsvg
Summary:                 Perl Module for RSVG library.
Version:                 5.8.4
%define file_type_version 0.10
Source:                  http://easynews.dl.sourceforge.net/sourceforge/gtk2-perl/Gnome2-Rsvg-%{file_type_version}.tar.gz
...
%build
cd Gnome2-Rsvg-%{file_type_version}
perl Makefile.PL \
