...
Summary:                 Gnome2-Print-%{tarball_version} PERL Module for libgnomeprint and libgnomeprintui
Version:                 %{perl_version}.%{tarball_version}
Source:                  http://easynews.dl.sourceforge.net/sourceforge/gtk2-perl/Gnome2-Print-%{tarball_version}.tar.gz
...
%build
cd Gnome2-Print-%{tarball_version}
perl Makefile.PL \
