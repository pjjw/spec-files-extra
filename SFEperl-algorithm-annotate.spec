...
#
# includes module(s): Algorithm-Annotate
#

%include Solaris.inc

%define algorithm_annotate_version 0.10
%define perl_version 5.8.4

Name:                    SFEperl-algorithm-annotate
Summary:                 Algorithm-Annotate-%{algorithm_annotate_version} PERL module
Version:                 %{perl_version}.%{algorithm_annotate_version}
Source:                  http://www.cpan.org/modules/by-module/Algorithm/Algorithm-Annotate-%{algorithm_annotate_version}.tar.gz
...
%build
cd Algorithm-Annotate-%{algorithm_annotate_version}
perl Makefile.PL \
