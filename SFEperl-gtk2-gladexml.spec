#
# spec file for package SFEperl-gtk2-gladexml
#
# includes module(s): perl-gtk2-gladexml
#

%include Solaris.inc

%define tarball_version 1.006
%define perl_version 5.8.4

Name:                    SFEperl-gtk2-gladexml
Summary:                 Gtk2-GladeXML-%{tarball_version} PERL Module for libglade
Version:                 %{perl_version}.%{tarball_version}
Source:                  http://easynews.dl.sourceforge.net/sourceforge/gtk2-perl/Gtk2-GladeXML-%{tarball_version}.tar.gz
...
%build
cd Gtk2-GladeXML-%{tarball_version}
perl Makefile.PL \
...
- Bump up version to 1.006
* Sat Aug 26 2006 - mike kiedrowski (lakeside-AT-cybrzn-DOT-com)
- Initial spec file
