...
%define io_compress_base_version 2.008
%define perl_version 5.8.4

Name:                    SFEperl-io-compress-base
Summary:                 IO-Compress-Base-%{io_compress_base_version} PERL module
Version:                 %{perl_version}.%{io_compress_base_version}
Source:                  http://www.cpan.org/modules/by-module/IO/IO-Compress-Base-%{io_compress_base_version}.tar.gz
...
%build
cd IO-Compress-Base-%{io_compress_base_version}
perl Makefile.PL \
