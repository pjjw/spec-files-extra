...
Version:                 5.8.4
%define file_type_version 0.14
Source:                  http://easynews.dl.sourceforge.net/sourceforge/gtk2-perl/Gnome2-Wnck-%{file_type_version}.tar.gz
...
%build
cd Gnome2-Wnck-%{file_type_version}
perl Makefile.PL \
