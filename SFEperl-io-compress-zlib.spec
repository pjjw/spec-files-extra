...
%define io_compress_zlib_version 2.008
%define perl_version 5.8.4

Name:                    SFEperl-io-compress-zlib
Summary:                 IO-Compress-Zlib-%{io_compress_zlib_version} PERL module
Version:                 %{perl_version}.%{io_compress_zlib_version}
Source:                  http://www.cpan.org/modules/by-module/IO/IO-Compress-Zlib-%{io_compress_zlib_version}.tar.gz
...
%build
cd IO-Compress-Zlib-%{io_compress_zlib_version}
perl Makefile.PL \
