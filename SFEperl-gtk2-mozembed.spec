...
Summary:                 Mozilla embedding widget.
Version:                 5.8.4
%define file_type_version 0.06
Source:                  http://easynews.dl.sourceforge.net/sourceforge/gtk2-perl/Gtk2-MozEmbed-%{file_type_version}.tar.gz
...
%build
cd Gtk2-MozEmbed-%{file_type_version}
perl Makefile.PL \
