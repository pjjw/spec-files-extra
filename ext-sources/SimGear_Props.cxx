...
//
// $Id: props.cxx,v 1.26.2.10 2007-10-13 14:05:48 durk Exp $
...
SGPropertyNode::setFloatValue (float value)
{
  ...
  case UNSPECIFIED: {
    char buf[128];
    if (snprintf(buf, 128, "%f", value) >= 128) {
#if PROPS_STANDALONE
         cerr << "caught buffer overflow in " << SG_ORIGIN << endl;
#else
         SG_LOG(SG_GENERAL, SG_ALERT, "caught buffer overflow in " << SG_ORIGIN);
#endif
    }
    result = set_string(buf);
    break;
