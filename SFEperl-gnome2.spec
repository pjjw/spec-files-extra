#
# spec file for package SFEperl-gnome2
#
#
# includes module(s): perl-gnome2
#
...
Source:                  %{sf_download}/gtk2-perl/Gnome2-%{tarball_version}.tar.gz
...
- Change name from SUNWperl-gnome2.spec to SFEperl-gnome2.spec
