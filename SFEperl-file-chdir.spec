...
#
# includes module(s): File-chdir
#


%include Solaris.inc

%define file_chdir_version 0.09
%define perl_version 5.8.4

Name:                    SFEperl-file-chdir
Summary:                 File-chdir-%{file_chdir_version} PERL module
Version:                 %{perl_version}.%{file_chdir_version}
Source:                  http://www.cpan.org/modules/by-module/File/File-chdir-%{file_chdir_version}.tar.gz
...
%build
cd File-chdir-%{file_chdir_version}
perl Makefile.PL \
